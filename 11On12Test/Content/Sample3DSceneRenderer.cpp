...
void Sample3DSceneRenderer::CreateDeviceDependentResources()
{
	...
	auto createD2DAssetsTask = createAssetsTask.then([this]() {
		m_deviceResources->GetD2DDeviceContext()->CreateSolidColorBrush(D2D1::ColorF(D2D1::ColorF::Green), &m_textBrush);
		DX::ThrowIfFailed(m_deviceResources->GetDWriteFactory()->CreateTextFormat(L"Verdana", NULL, DWRITE_FONT_WEIGHT_NORMAL, DWRITE_FONT_STYLE_NORMAL, DWRITE_FONT_STRETCH_NORMAL, 50, L"en-us", &m_textFormat));
...
bool Sample3DSceneRenderer::Render()
{
	...
	ID3D11Resource* resources[] = { m_deviceResources->GetWrappedBackBuffer() };
	m_deviceResources->GetD3D11On12Device()->AcquireWrappedResources(resources, ARRAYSIZE(resources));
	...
	m_deviceResources->GetD3D11DeviceContext()->Flush(); // This performs the ResourceBarrier.
